...
public class PauseMobGrowthParticle extends SingleQuadParticle {

    public PauseMobGrowthParticle(
        ...
        double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet)
    {
        ...
        // this.y += (2.0 * this.random.nextDouble() - 1.0) * 0.2;
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        {
            return new PauseMobGrowthParticle(clientLevel, x, y, z, velocityX, velocityY, velocityZ, this.spriteSet);
        }
    }
}
